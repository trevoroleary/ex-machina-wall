...
from raspberry_pi_controller.audio_reactor.fft import getFFT
...
class Stream_Analyzer:
    ...
    def __init__(self,
        ...
        try:
            from raspberry_pi_controller.audio_reactor.stream_reader_pyaudio import Stream_Reader
            ...
            from raspberry_pi_controller.audio_reactor.stream_reader_sounddevice import Stream_Reader
            self.stream_reader = Stream_Reader(
                device  = device,
                rate    = rate,
                updates_per_second  = updates_per_second,
        ...
        if self.visualize:
            from raspberry_pi_controller.audio_reactor.visualizer import Spectrum_Visualizer
